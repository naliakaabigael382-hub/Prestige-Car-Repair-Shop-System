<template>
    <div class="sidebar">
        ...
        <div class="menu-items">
             <router-link to="/mechanicDashboard" active-class="active" tag="button" exact class="side-btn">
                <div class="link-container">
                    Overview
                </div>
            </router-link>
            <router-link to="/mechanicDashboard/myAccount" active-class="active" tag="button" exact class="side-btn">
                <div class="link-container">
                    My Account
                </div>
            </router-link>
        ...
        <div style="position: absolute; left: 5px; bottom: 5px; color: #D3D2E1;font-size: 20px; " >
            <img src="../assets/exit.png" width = "30" length = "20" >
             log out 
        </div>
